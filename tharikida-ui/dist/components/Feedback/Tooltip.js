...
const Tooltip = ({ content, children, position = "top", styles = {}, className = "", transitionDuration = 180, }) => {
    ...
    return (_jsxs("span", { style: { position: "relative", display: "inline-block" }, className: className, onMouseEnter: () => setVisible(true), onMouseLeave: () => setVisible(false), onFocus: () => setVisible(true), onBlur: () => setVisible(false), tabIndex: 0, children: [children, show && (_jsx("span", { style: {
                    position: "absolute",
                    zIndex: 999,
