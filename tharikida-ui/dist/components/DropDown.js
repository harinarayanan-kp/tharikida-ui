    ...
    return (React.createElement("div", { style: { position: "relative", width: width || "100%" } },
        React.createElement("div", { style: {
            ...
            React.createElement("svg", { style: {
                ...
                React.createElement("path", { d: "M1.37565 0.499999L7.43782 6.5L13.5 0.5", stroke: "black", "stroke-linecap": "round" }))),
        isOpen && (React.createElement("ul", { ref: dropdownRef, style: {
                boxSizing: "border-box",
                zIndex: 1000,
                margin: 0,
                padding: "10px",
                ...
                maxHeight: "300px",
                overflowY: "auto",
            } }, options.map((option, index) => (React.createElement("li", { key: index, style: {
                fontFamily: "montserrat",
                padding: "8px 10px",
                cursor: "pointer",
